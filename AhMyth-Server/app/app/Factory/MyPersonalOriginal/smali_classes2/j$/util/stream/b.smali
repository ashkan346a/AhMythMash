...
.method private S(I)Lj$/util/Spliterator;
    ...
    invoke-virtual {v3, v4}, Lj$/util/stream/c3;->m(I)Z
...
# virtual methods
.method final A(Lj$/util/Spliterator;Lj$/util/stream/o2;)V
    .locals 2
    ...
    invoke-interface {p2, v0, v1}, Lj$/util/stream/o2;->l(J)V

    .line 484
    invoke-interface {p1, p2}, Lj$/util/Spliterator;->forEachRemaining(Ljava/util/function/Consumer;)V

    .line 485
    invoke-interface {p2}, Lj$/util/stream/o2;->k()V

    return-void

    .line 488
    :cond_0
    invoke-virtual {p0, p1, p2}, Lj$/util/stream/b;->B(Lj$/util/Spliterator;Lj$/util/stream/o2;)Z

    return-void
.end method

.method final B(Lj$/util/Spliterator;Lj$/util/stream/o2;)Z
    .locals 3
    ...
    invoke-interface {p2, v1, v2}, Lj$/util/stream/o2;->l(J)V

    .line 502
    invoke-virtual {v0, p1, p2}, Lj$/util/stream/b;->H(Lj$/util/Spliterator;Lj$/util/stream/o2;)Z
...
.method final C(Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/J0;
    ...
    .line 550
    invoke-virtual {p0, p1, p2}, Lj$/util/stream/b;->V(Lj$/util/Spliterator;Lj$/util/stream/o2;)Lj$/util/stream/o2;
...
.method final D(Lj$/util/stream/I3;)Ljava/lang/Object;
    .locals 1
    ...
    invoke-interface {p1, p0, v0}, Lj$/util/stream/I3;->c(Lj$/util/stream/b;Lj$/util/Spliterator;)Ljava/lang/Object;
    ...
    invoke-interface {p1, p0, v0}, Lj$/util/stream/I3;->b(Lj$/util/stream/b;Lj$/util/Spliterator;)Ljava/lang/Object;
...
.method abstract H(Lj$/util/Spliterator;Lj$/util/stream/o2;)Z
.end method

.method abstract I()Lj$/util/stream/d3;
.end method

.method final J()Lj$/util/stream/d3;
    .locals 2
...
.method abstract R(ILj$/util/stream/o2;)Lj$/util/stream/o2;
.end method
...
.method final V(Lj$/util/Spliterator;Lj$/util/stream/o2;)Lj$/util/stream/o2;
    .locals 1
    ...
    invoke-virtual {p0, v0}, Lj$/util/stream/b;->W(Lj$/util/stream/o2;)Lj$/util/stream/o2;

    move-result-object v0

    invoke-virtual {p0, p1, v0}, Lj$/util/stream/b;->A(Lj$/util/Spliterator;Lj$/util/stream/o2;)V

    return-object p2
.end method

.method final W(Lj$/util/stream/o2;)Lj$/util/stream/o2;
    .locals 3
    ...
    invoke-virtual {v0, v2, p1}, Lj$/util/stream/b;->R(ILj$/util/stream/o2;)Lj$/util/stream/o2;
