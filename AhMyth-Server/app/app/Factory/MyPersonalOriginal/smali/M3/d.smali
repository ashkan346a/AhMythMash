...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    .line 21
    invoke-static {p1, v1, v3}, La/a;->v(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
...
.method public final b(Landroid/content/Context;)Landroid/graphics/Typeface;
    ...
    .line 15
    .line 16
    invoke-static {p1, v0}, LI/k;->b(Landroid/content/Context;I)Landroid/graphics/Typeface;
...
.method public final c(Landroid/content/Context;Landroid/support/v4/media/session/i;)V
    .locals 9
    ...
    .line 26
    .line 27
    invoke-virtual {p2, p1, v1}, Landroid/support/v4/media/session/i;->M(Landroid/graphics/Typeface;Z)V
    ...
    .line 32
    .line 33
    invoke-direct {v6, p0, p2}, LM3/b;-><init>(LM3/d;Landroid/support/v4/media/session/i;)V

    .line 34
    .line 35
    .line 36
    sget-object v0, LI/k;->a:Ljava/lang/ThreadLocal;
    ...
    .line 45
    invoke-virtual {v6, p1}, LI/b;->a(I)V
    ...
    .line 88
    invoke-virtual {p2, p1}, Landroid/support/v4/media/session/i;->L(I)V
    ...
    .line 93
    .line 94
    invoke-virtual {p2, v1}, Landroid/support/v4/media/session/i;->L(I)V
...
.method public final d(Landroid/content/Context;)Z
    ...
    .line 5
    .line 6
    sget-object v1, LI/k;->a:Ljava/lang/ThreadLocal;
    ...
    .line 25
    invoke-static/range {v1 .. v7}, LI/k;->c(Landroid/content/Context;ILandroid/util/TypedValue;ILI/b;ZZ)Landroid/graphics/Typeface;
...
.method public final e(Landroid/content/Context;Landroid/text/TextPaint;Landroid/support/v4/media/session/i;)V
    .locals 2

    .line 1
    invoke-virtual {p0, p1, p2, p3}, LM3/d;->f(Landroid/content/Context;Landroid/text/TextPaint;Landroid/support/v4/media/session/i;)V
...
.method public final f(Landroid/content/Context;Landroid/text/TextPaint;Landroid/support/v4/media/session/i;)V
    .locals 1
    ...
    .line 24
    .line 25
    invoke-direct {v0, p0, p1, p2, p3}, LM3/c;-><init>(LM3/d;Landroid/content/Context;Landroid/text/TextPaint;Landroid/support/v4/media/session/i;)V

    .line 26
    .line 27
    .line 28
    invoke-virtual {p0, p1, v0}, LM3/d;->c(Landroid/content/Context;Landroid/support/v4/media/session/i;)V
...
.method public final g(Landroid/content/Context;Landroid/text/TextPaint;Landroid/graphics/Typeface;)V
    ...
    .line 9
    invoke-static {p1, p3}, Lb3/a;->x(Landroid/content/res/Configuration;Landroid/graphics/Typeface;)Landroid/graphics/Typeface;
